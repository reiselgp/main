...
/**
 * Test for /crear_plan/leer_excel
 */
Test('/crear_plan/leer_excel', function (t) {
    ...
    Parser.validate(apiPath, function (err, api) {
         ...
         */
        t.test('test excel_reader post operation', function (t) {
            Mockgen().requests({
                ...
                request.end(function (err, res) {
                    ...
                    var validate = Validator(api.paths['/crear_plan/leer_excel']['post']['responses']['200']['schema']);
