...
/**
 * Test for /subdeparments
 */
Test('/subdeparments', function (t) {
    ...
    Parser.validate(apiPath, function (err, api) {
         ...
         */
        t.test('test getSubDeparmentsByPlanId get operation', function (t) {
            Mockgen().requests({
                path: '/subdeparments',
                operation: 'get'
            }, function (err, mock) {
                ...
                request.end(function (err, res) {
                    ...
                    var validate = Validator(api.paths['/subdeparments']['get']['responses']['200']['schema']);
