...
/**
 * Test for /price-points
 */
Test('/price-points', function (t) {
    ...
    Parser.validate(apiPath, function (err, api) {
         ...
         */
        t.test('test getPricePointsByDivisionId get operation', function (t) {
            Mockgen().requests({
                path: '/price-points',
                operation: 'get'
            }, function (err, mock) {
                ...
                request.end(function (err, res) {
                    ...
                    var validate = Validator(api.paths['/price-points']['get']['responses']['200']['schema']);
